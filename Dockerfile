...
# adding drivers
COPY mysql-connector-j-8.1.0-1.el8.noarch.rpm /tmp
RUN cd /tmp && yum -y localinstall 'mysql-connector-j-8.1.0-1.el8.noarch.rpm'

COPY postgresql-42.6.0.jar /usr/java/jdk-21/lib/
COPY mssql-jdbc-12.4.1.jre8.jar /usr/java/jdk-21/lib/
